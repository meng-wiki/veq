...
# 0. 全局配置与阶数设定
# ==========================================
N_thetaR = 2    # thetaR 极向扰动的环向展开阶数
N_thetaZ = 2    # thetaZ 极向扰动的环向展开阶数
N_c0R = 2       # c0R 的环向展开阶数
N_c0Z = 2       # c0Z 的环向展开阶数
N_h = 2         # h 的环向展开阶数
N_nu = 2        # nu (垂直平移 v) 的环向展开阶数
N_a = 2         # a (小半径) 的环向展开阶数
N_kappa = 2     # kappa (拉长比) 的环向展开阶数

M_R_final = 2   # R 的极向扰动阶数 M_R
M_Z_final = 2   # Z 的极向扰动阶数 M_Z
